"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[652],{96652:(t,e,n)=>{n.d(e,{SIWEController:()=>c,getDidAddress:()=>o.q_h,getDidChainId:()=>o.aG$});var i=n(4707),s=n(29073),a=n(8324);const r=(0,s.BX)({status:"uninitialized"}),c={state:r,subscribeKey:(t,e)=>(0,i.u$)(r,t,e),subscribe:t=>(0,s.B1)(r,(()=>t(r))),_getClient(){if(!r._client)throw new Error("SIWEController client not set");return r._client},async getNonce(t){const e=this._getClient(),n=await e.getNonce(t);return this.setNonce(n),n},async getSession(){try{const t=this._getClient(),e=await t.getSession();return e&&(this.setSession(e),this.setStatus("success")),e||void 0}catch{return}},createMessage(t){const e=this._getClient().createMessage(t);return this.setMessage(e),e},async verifyMessage(t){const e=this._getClient();return await e.verifyMessage(t)},async signIn(){const t=this._getClient();return await t.signIn()},async signOut(){const t=this._getClient();await t.signOut(),this.setStatus("ready"),this.setSession(void 0),t.onSignOut?.()},onSignIn(t){const e=this._getClient();e.onSignIn?.(t)},onSignOut(){const t=this._getClient();t.onSignOut?.()},async setSIWEClient(t){r._client=(0,s.KR)(t),r.session=await this.getSession(),r.status=r.session?"success":"ready",a.WB.setAccountProp("siweStatus",r.status,"eip155"),a.Hd.setIsSiweEnabled(t.options.enabled)},setNonce(t){r.nonce=t},setStatus(t){r.status=t,a.WB.setAccountProp("siweStatus",r.status,"eip155")},setMessage(t){r.message=t},setSession(t){r.session=t,r.status=t?"success":"ready",a.WB.setAccountProp("siweStatus",r.status,"eip155")}};n(11079);var o=n(51619),l=n(57104),u=n(51263);const g=u.AH`
  :host {
    display: flex;
